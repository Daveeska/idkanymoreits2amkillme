...
public class BaitCommand extends AbstractSubCommand {
    ...
    public static class GetCommand extends AbstractSubCommand {
        ...
        public boolean onCommand(CommandSender sender, List<String> args) {
            ...
            if (args.size() == 1){
                ItemStackUtils.givePlayerBait((Player) sender, args.get(0), 0);
                ...
                ItemStackUtils.givePlayerBait((Player) sender, args.get(0), Integer.parseInt(args.get(1)));
    ...
    public static class GiveCommand extends AbstractSubCommand {
        ...
        public boolean onCommand(CommandSender sender, List<String> args) {
            ...
            if (args.size() == 2){
                ItemStackUtils.givePlayerBait(Bukkit.getPlayer(args.get(0)), args.get(1), 0);
                ...
                ItemStackUtils.givePlayerBait(Bukkit.getPlayer(args.get(0)), args.get(1), Integer.parseInt(args.get(2)));
